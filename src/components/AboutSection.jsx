import { Briefcase, Code, User, ChartBar, ChartBarIcon, ChartArea, ChartBarBigIcon, ChartColumnBig} from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Web Developer & Tech Inventor
            </h3>

            <p className="text-muted-foreground">
                I'm a full-stack developer with over 2 years of
                experience in building dynamic and responsive web
                applications. My expertise lies in JavaScript, React, Node.js,
                and Python, and I have a strong background in both front-end
                and back-end development.
            </p>

            <p className="text-muted-foreground">
              I'm passionate about creating innovative solutions that
              enhance user experiences and drive business growth. When I'm not
...
>>>>>>> 9eec652235e60dab2a2ee3644497c6c5d295e9d3
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Protecting systems and networks from cyber threats, identifying
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-full bg-primary/10">
                  <ChartColumnBig className="h-6 w-6 text-primary" />
                </div>
